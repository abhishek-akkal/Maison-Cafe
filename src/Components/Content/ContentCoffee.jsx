...
import ContentCoffeeH1 from "../../assets/HomeContent/ContentCoffeeH1.png";
import ContentCoffeeBox1 from "../../assets/HomeContent/ContentCoffeeBox1.png";
import ContentCoffeeBox2 from "../../assets/HomeContent/ContentCoffeeBox2.png";
import ContentCoffeeBox3 from "../../assets/HomeContent/ContentCoffeeBox3.png";
import ContentCoffeeBox4 from "../../assets/HomeContent/ContentCoffeeBox4.png";
import { SiCoffeescript } from "react-icons/si";
import { HiArrowRight } from "react-icons/hi";

const coffees = [
  { img: ContentCoffeeBox1, name: "Cappuccino", price: "$3.20" },
  { img: ContentCoffeeBox2, name: "Latte", price: "$3.40" },
  { img: ContentCoffeeBox3, name: "Mocha", price: "$3.60" },
  { img: ContentCoffeeBox4, name: "Espresso", price: "$2.50" },
];
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex items-center justify-center">
        <div className="h-130 w-370 bg-[#F8F2EC] mt-15 flex justify-between rounded-2xl shadow-gray-300 shadow-lg">
          <div className="flex flex-col items-start justify-around">
            <div className="flex items-center justify-center relative">
              <div className="flex flex-col justify-between px-15 gap-3">
                <SiCoffeescript className="text-[#f09000] text-4xl relative left-25" />
                <div className="text-3xl font-bold font-serif italic">
                  Our Popular Coffees
                </div>
                <div className="w-20 h-1 bg-[#f49506] rounded-full"></div>
                <div className="font-[lora]">
                  Handcrafted with premium beans,
                </div>
                <div className="relative bottom-2 font-[lora]">
                  brewed to perfection for your comfort
                </div>
              </div>
              <Link
                to="/coffee"
      ...
      {/* Mobile/Tablet — simple stacked layout, hidden above lg */}
      <div className="lg:hidden px-4 mt-10">
        <div className="bg-[#F8F2EC] rounded-2xl shadow-gray-300 shadow-lg p-6">
          <div className="flex items-center justify-between mb-5">
            <div className="flex flex-col gap-2">
              <SiCoffeescript className="text-[#f09000] text-3xl" />
              ...
              <p className="font-[lora] text-sm text-gray-600">
                Handcrafted with premium beans, brewed to perfection.
              </p>
            </div>
            <Link
              to="/coffee"
